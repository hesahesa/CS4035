...
data <- sqldf(c('update data set issuercountrycode="A",  shoppercountrycode="B" where issuercountrycode<>shoppercountrycode', 'select * from main.data'))
data <- sqldf(c('update data set issuercountrycode="A",  shoppercountrycode="A" where issuercountrycode=shoppercountrycode', 'select * from main.data'))
